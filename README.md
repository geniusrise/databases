...
These are data ingestion modules for various databases. These components are `Spout`s that can be connected to downstreams batch-type bolts that can then process this data (e.g. for bulk processing usecases).
